...
| 后端 | Java 25 + Spring Boot 4.0.6 + Spring AI 2.0.0-M8 |
| 前端 | Flutter Web 3.7+ |
...
| API 容器 | ✅ | eclipse-temurin JRE 镜像 + 挂载 JAR |
| Web 容器 | ✅ | Caddy 镜像 + 挂载静态产物（可选 bundled-caddy） |
...
| 脚本 | 说明 |
|------|------|
| scripts/dev-api.sh | 开发脚本（自动检测 Java 25、启动依赖、运行应用） |
...
client
REDACTED_GITHUB_CLIENT_ID_1
Client secrets
REDACTED_GITHUB_CLIENT_SECRET_1

client
REDACTED_GITHUB_CLIENT_ID_2
Client secrets
REDACTED_GITHUB_CLIENT_SECRET_2
